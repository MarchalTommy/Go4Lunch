...
public class PlusCode implements Serializable, Parcelable
{
    ...
    public final static Creator<PlusCode> CREATOR = new Creator<PlusCode>() {
        ...
        public com.aki.go4lunch.models.PlusCode createFromParcel(Parcel in) {
            return new com.aki.go4lunch.models.PlusCode(in);
        }

        public com.aki.go4lunch.models.PlusCode[] newArray(int size) {
            return (new com.aki.go4lunch.models.PlusCode[size]);
        }
    ...
    public com.aki.go4lunch.models.PlusCode withCompoundCode(String compoundCode) {
        this.compoundCode = compoundCode;
        return this;
    }
    ...
    public com.aki.go4lunch.models.PlusCode withGlobalCode(String globalCode) {
        this.globalCode = globalCode;
        return this;
    }
